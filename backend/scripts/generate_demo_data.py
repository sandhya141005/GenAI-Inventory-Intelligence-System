...
scenarios = {
    ...
    ("SKU-1001", "Chennai Central"): (12, 25),
    ...
    ("SKU-2002", "Chennai Central"): (4, 8),   # stockout risk
    ("SKU-2002", "Ambattur Hub"): (2, 180),      # overstock -> transfer source
    ("SKU-2002", "Coimbatore Store"): (2, 25),
    ("SKU-2002", "Madurai Store"): (1, 20),

    # Power Bank: healthy, higher value item
    ("SKU-2003", "Chennai Central"): (8,15),
    ("SKU-2003", "Ambattur Hub"): (2, 20),
    ("SKU-2003", "Coimbatore Store"): (2, 22),
    ("SKU-2003", "Madurai Store"): (2, 180),
