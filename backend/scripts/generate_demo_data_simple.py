"""
McKinsey Executive Demo Data Generator (Simplified - no user creation)
Generates realistic automotive inventory data with coherent business relationships
Run this first, then create user manually or via API
"""
...
def generate_demo_data():
    ...
    try:
        ...
        print("\n⚠️  NOTE: User account NOT created by this script")
        print("   Create user via /api/auth/signup endpoint:")
        print("   POST http://localhost:8000/api/auth/signup")
        print("   Body: {\"email\": \"demo@mckinsey.com\", \"password\": \"demo1234\", \"full_name\": \"McKinsey Demo User\"}")
        print("\n✨ Data ready for McKinsey Executive Demo!")
        print("=" * 60)
